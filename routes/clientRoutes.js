...
const { getClients, getClientById, createClient, updateClient, deleteClient, getClientMenuPermissions, saveClientMenuPermissions } = require('../controllers/clientController');
