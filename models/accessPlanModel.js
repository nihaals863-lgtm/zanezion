...
class AccessPlan {
    static async getAll() {
        ...
        return rows.map(row => ({
            ...row,
            yearlyPrice: row.yearly_price, // Map to camelCase for frontend
    ...
    static async create(data) {
        const { id, name, tier, price, period, yearly_price, yearlyPrice, description, features, commitment } = data;
